   ...
   const { token, backendUrl, userData, setUserData, loadUserProfileData } = useContext(AppContext)
    ...
    const updateUserProfileData = async () => {
        ...
        try {
            ...
            formData.append('marriedstatus', userData.marriedstatus)
    ...
    return userData ? (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600'>
                    ...
                    {isEdit
                      ...
                      <p className='font-medium'>MarriedStatus:</p>
                      {isEdit
                        ? <select className='max-w-20 bg-gray-50' onChange={(e) => setUserData(prev => ({ ...prev, marriedstatus: e.target.value }))} value={userData.marriedstatus} >
                            <option value="">Not Selected</option>
                            <option value="Single">Single</option>
                            <option value="Married">Married</option>
                        </select>
                        : <p className='text-gray-500'>{userData.marriedstatus}</p>
                    }
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-blue-400 px-8 py-2 rounded-full hover:bg-[#2E8BE1] hover:text-white transition-all'>Save information</button>
                    : <button onClick={() => setIsEdit(true)} className='border border-blue-400 px-8 py-2 rounded-full hover:bg-[#2E8BE1] hover:text-white transition-all'>Edit</button>
                }
